...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class FsmComponentInspector : GameFrameworkInspector
    {
        ...
        {
            EditorGUILayout.LabelField(fsm.FullName, fsm.IsRunning ? Utility.TextUtility.Format("{0}, {1:F1} s", fsm.CurrentStateName, fsm.CurrentStateTime) : (fsm.IsDestroyed ? "Destroyed" : "Not Running"));
        }
    }
}

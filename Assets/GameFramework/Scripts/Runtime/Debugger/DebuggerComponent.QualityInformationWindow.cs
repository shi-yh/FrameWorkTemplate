        ...
        private sealed class QualityInformationWindow : ScrollableDebuggerWindowBase
        {
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    DrawItem("Async Upload Time Slice", Utility.TextUtility.Format("{0} ms", QualitySettings.asyncUploadTimeSlice));
                    DrawItem("Async Upload Buffer Size", Utility.TextUtility.Format("{0} MB", QualitySettings.asyncUploadBufferSize));

        ...
        private sealed class GraphicsInformationWindow : ScrollableDebuggerWindowBase
        {
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    DrawItem("Memory Size", Utility.TextUtility.Format("{0} MB", SystemInfo.graphicsMemorySize));
            ...
            {
                return Utility.TextUtility.Format("Shader Model {0}.{1}", shaderLevel / 10, shaderLevel % 10);
            }
        }
    }
}
